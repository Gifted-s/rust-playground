fn main() {
    ...
    // movei(x);
    // println!("name is {}", x);
     // move does not happen for simple primitive types
    ...
    */
    ...
    //  let length = firstword(&string); 
    //  s.clear();

      
} 

// won't work because you are borrowing a value that will be dropped immediatly after return (RUST NOT PERMIT DANGLING POINTERS) 
// fn dangle() -> &String {
